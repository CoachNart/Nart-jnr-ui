...
export default function StandaloneShell({ children, title }: { children: ReactNode; title?: string }) {
  ...
  return <div className="relative min-h-screen overflow-x-hidden bg-[#050607] text-white">
    ...
    <main className="relative z-[1] mx-auto max-w-6xl px-4 pb-28 pt-24 sm:px-5 md:px-8 md:pt-28">{title&&<div className="mb-7"><h1 className="text-2xl font-semibold tracking-[-.025em] text-white md:text-3xl">{title}</h1><div className="nart-line mt-4 h-px w-full opacity-30"/></div>}{children}</main>
